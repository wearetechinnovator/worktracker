...
const DEFAULT_INLINE_TASKS: Task[] = [
  {
    ...
    description: 'Refactor CSS variable bindings and add Modal dark theme toggles.',
    projectId: { _id: 'proj-1', name: 'AI WorkTracker Pro', color: '#4f46e5' },
    assignedTo: [{ _id: 'emp-1', name: 'Alex Johnson', email: 'alex@techinnovator.com', avatarColor: '#4f46e5' }],
    priority: 'High',
    status: 'In Progress',
    dueDate: '2026-09-15',
    dueTime: '17:00',
  ...
  },
  {
    ...
    description: 'Add index hints and optimize daily attendance report queries.',
    projectId: { _id: 'proj-2', name: 'Mobile Banking App', color: '#ec4899' },
    assignedTo: [{ _id: 'emp-3', name: 'Michael Scott', email: 'michael@techinnovator.com', avatarColor: '#10b981' }],
    priority: 'Urgent',
    status: 'To Do',
    dueDate: '2026-09-20',
    dueTime: '18:00',
  ...
  {
    _id: 'task-103',
    title: 'Design Biometric Authentication Flow',
    description: 'Create Figma wireframes and interactive micro-animations for FaceID.',
    projectId: { _id: 'proj-2', name: 'Mobile Banking App', color: '#ec4899' },
    assignedTo: [{ _id: 'emp-4', name: 'Dwight Schrute', email: 'dwight@techinnovator.com', avatarColor: '#f59e0b' }],
    priority: 'Medium',
    status: 'Completed',
    dueDate: '2026-09-10',
    dueTime: '16:00',
...
export default function TasksPage() {
  ...
  const [tasks, setTasks] = useState<Task[]>(DEFAULT_INLINE_TASKS);
  ...
  const loadAllData = useCallback(async () => {
    try {
      const allTasks = staticClient.getTasks();
